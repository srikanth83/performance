...
/**
 * Created by sreekanth.bongunuri on 27/06/16.
 */
class TestCheckout extends Simulation{
  ...
  val checkoutScenario =
    scenario("checkout")
      .exec(homePage.homepage,search.search, pdpPage.pdpPage, addProductToTheCart.addProductToTheCart,navigateToTheLoginPage.navigateToLoginPage,loginPage.loginPage,checkoutPage.checkoutPage)
